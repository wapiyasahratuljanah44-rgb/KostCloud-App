...
<div class="bg-white rounded-xl shadow p-8">
    <a href="{{ route('kost.show', $property->id) }}" class="text-blue-600 hover:underline mb-4 inline-block">&larr; Kembali ke Detail</a>
    ...
    <form action="{{ route('kost.update', $property->id) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('kost.show', $property->id) }}" class="text-gray-600 hover:underline">Batal</a>
        </div>
    </form>
</div>
@endsection
